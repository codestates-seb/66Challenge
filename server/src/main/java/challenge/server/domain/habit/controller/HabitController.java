package challenge.server.domain.habit.controller;
...
import challenge.server.domain.bookmark.mapper.BookmarkMapper;
import challenge.server.domain.bookmark.service.BookmarkService;
...
import challenge.server.domain.report.mapper.ReportMapperImpl;
import challenge.server.domain.report.service.ReportService;
...
import challenge.server.domain.review.service.ReviewService;
...
public class HabitController {
    ...
    public ResponseEntity getReviewsByHabit(@PathVariable("habit-id") @Positive Long habitId,
        ...
        return new ResponseEntity(reviewService.findAllByHabit(lastId, habitId, size), HttpStatus.OK);
    }
