package challenge.server.domain.user.mapper;
...
import static challenge.server.domain.user.entity.User.Gender.FEMALE;
import static challenge.server.domain.user.entity.User.Gender.MALE;
