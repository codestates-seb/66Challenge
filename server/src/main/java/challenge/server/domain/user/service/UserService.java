package challenge.server.domain.user.service;

import challenge.server.domain.bookmark.entity.Bookmark;
import challenge.server.domain.bookmark.repository.BookmarkRepository;
...
import challenge.server.domain.user.mapper.UserMapperImpl;
import challenge.server.domain.user.repository.EmailVerificationRepository;
import challenge.server.domain.user.repository.LogoutListRepository;
import challenge.server.domain.user.repository.QUserRepository;
...
import static challenge.server.domain.user.entity.User.Status.ACTIVE;
import static challenge.server.domain.user.entity.User.Status.QUIT;
