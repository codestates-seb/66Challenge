...
const HabitDetail: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://66challenge.shop/" />
        <title>66Challenge | {habitData?.overview?.title}</title>
        <meta
          name="description"
          content="66일 동안 습관 만들기! 좋은 습관 구경하러 가기!"
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content={`66Challenge | ${habitData?.overview?.title}`}
        />
        <meta
          property="og:description"
          content="66일 동안 습관 만들기! 좋은 습관 구경하러 가기!"
        />
        <meta property="og:image" content={habitData?.overview?.thumbImgUrl} />
      </Head>
          ...
          <div className="habit-detail-top-info p-5 border-b border-borderColor">
            ...
            <div className="habit-detail-metainfo-container flex items-center gap-2.5 h-[30px] leading-[35px]">
              <div className="habit-detail-postuser-profile-image w-[30px]">
                <Image
                  src={
                    habitData?.detail?.hostUserImgUrl ||
                    '/image/baseProfile.svg'
                  }
